...
export function AboutPage() {
  return (
    <div className="h-full flex flex-col md:flex-row p-6 sm:p-8 md:p-12 lg:p-16 gap-8 md:gap-12 relative overflow-hidden">
      {/* Left Side - Profile */}
      <div className="w-full md:w-1/3 flex flex-col items-center justify-center">
        {/* Profile Image Placeholder */}
        <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-gray-100 border border-gray-200 mb-6 overflow-hidden">
          <img 
            src={profileImage} 
            alt="Simone Teles" 
        ...
        <div className="text-center">
          <div className="flex items-center gap-3 justify-center mb-4">
            ...
            <h2 className="text-xl sm:text-2xl text-gray-900">Sobre mim</h2>
            <div className="w-6 h-px bg-gray-900" />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center space-y-6 sm:space-y-8">
        <div className="border-l-2 border-gray-900 pl-4 sm:pl-6">
